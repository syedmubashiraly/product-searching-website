...
function searchButton() {
  for (var keys in watches[selectedBrand]) {
    if (watches[selectedBrand][keys].name === selectedProduct) {
      ...
      var final_Submit = document.getElementById("finalSubmit");
      console.log(watches[selectedBrand][keys].img)
      final_Submit.innerHTML += `
        
    <div class="card product-card mt-5">
      <div class="product-img" style="width: 50px;">
        <img
          
          src="${watches[selectedBrand][keys].img}"
          alt=""
        />
      </div>
      <div class="product-detail">
        <p id="name">Name : ${watches[selectedBrand][keys].name}</p>
        <p id="price">price : ${watches[selectedBrand][keys].price}</p>
        <p id="fullName">
          Full Name : ${watches[selectedBrand][keys].fullName}
        </p>
        <p id="Category">
          Category : ${watches[selectedBrand][keys].category }
        </p>
        <p id="Caption">Caption : ${watches[selectedBrand][keys].caption}</p>
        <p id="tag">Tag : ${watches[selectedBrand][keys].Tags}</p>
        <p id="color">Color : ${watches[selectedBrand][keys].color}</p>
      </div>
      <div class="actions">
